...
sy keyword javaAccessKeyword    void public protected private class static transient final abstract new byte short int long char float double
...
sy keyword javaStructure        interface     skipwhite skipempty nextgroup=javaType
